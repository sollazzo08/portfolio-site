  ...
  return (
    <html className="bg-[#191919] font-tektur text-gray-400" lang="en">
      <body className="flex flex-col items-center min-h-screen">
        ...
        <div className="hidden md:block fixed bottom-4 right-4 z-50 text-[12px] text-gray-400 opacity-70 hover:opacity-100 transition-opacity pointer-events-none">
          Self Hosted on Raspberry Pi
        </div>
        <div className="hidden md:flex flex-col gap-4 fixed top-4 right-4 z-50 text-gray-400 opacity-70 hover:opacity-100 transition-opacity">
          <a
